    ...
    <header>
        <nav class="navbar rounded fixed-bottom mx-1 mb-1" style="background-color:rgba(59, 72, 109, 0.8)">
            <div class="container">
                ...
                <a class="btn btn-outline-light rounded py-1 px-2" href="#waktu"><i data-feather="calendar" style="width:17px"></i></a>
                <a class="btn btn-outline-light rounded py-1 px-2" href="#party"><i data-feather="gift" style="width:17px"></i></a>
                @if($mempelai->story == 1)
                <a class="btn btn-outline-light rounded py-1 px-2" href="#story"><i data-feather="heart" style="width:17px"></i></a>
                @endif
                <a class="btn btn-outline-light rounded py-1 px-2" href="#gallery"><i data-feather="aperture" style="width:17px"></i></a>
                <a class="btn btn-outline-light rounded py-1 px-2" href="#doa"><i data-feather="mail" style="width:17px"></i></a>
                <a class="btn btn-outline-light rounded py-1 px-2" href="#mengundang"><i data-feather="list" style="width:17px"></i></a>
            </div>
        </nav>
    </header>
    {{-- Hidden Input --}}
    ...
    <main>
            ...
            <div class="conteiner kartu m-2 " style="padding : 10px 10px; height: 90vh;">
                ...
                <div class="row mb-3 pt-5">
                    <div id="salam" class="col">
                        <h1 class="fs-3 fw-bold text-center" style="font-family: 'Times New Roman', Times, serif; color: #3B486D;">
                            Assalamualaikum
                            Wr. Wb.</h1>
                    </div>
                </div>
                ...
                <div class="row text-center">
                    ...
                    <div id="img-wanita" class="col-5">
                        <img width="120px" src="/storage/post-images/mempelai/{{ $mempelai->photo_wanita }}" class="img-thumbnail rounded-circle foto-wanita" alt="">
                    </div>
                </div>
                <!-- Nama Pria -->
            ...
            <div class="container-fluid kartu" style="padding : 10px 10px;">
                <div class="row">
                    <div id="day" class="col">
                        <h1 class="h1 text-center fw-bold fs-1" style="font-family: 'Times New Roman', Times, serif; color:#3B486D">Acara</h1>
                    </div>
                </div>
                <div class="kartu2" style="padding : 10px 10px;">
                    ...
                    <div class="row">
                        <div id="akad" class="col">
                            <p class="text-center fs-4 fw-bold mb-2 border rounded" style="font-family: 'Times New Roman', Times, serif; color:#3B486D">Akad Nikah</p>
                        </div>
                    </div>
                    {{-- Hari Akad --}}
                    <div class="row">
                        <div id="hari" class="col-12">
                            <h5 class="text-center fw-bold" style="font-family: 'Times New Roman', Times, serif; color:#3B486D">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="d-flex justify-content-center align-items-center">
                                        <a href="{{ $mempelai->link_akad }}" target="_blank" class="badge mt-2" style="background-color: rgb(59, 72, 109)"><i data-feather="map" class="me-2"></i>Lihat
                                            Lokasi</a>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="row mt-3" id="party" style="padding-top:15px;">
                        ...
                        <div id="resepsi" class="col">
                            <p class="text-center fs-4 fw-bold mb-2 border rounded" style="font-family: 'Times New Roman', Times, serif; color:#3B486D">Resepsi</p>
                        </div>
                    </div>
                        ...
                        <div class="col">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="d-flex justify-content-center align-items-center">
                                        <a href="{{ $mempelai->link_resepsi }}" target="_blank" class="badge mt-2" style="background-color: rgb(59, 72, 109)"><i data-feather="map" class="me-2"></i>Lihat
                                            Lokasi</a>
                                    </div>
                                </div>
                            </div>
        ...
        <section id="story" class="mb-3 p-2">
            <div class="container-fluid kartu" style="padding : 10px 10px;">
                <div class="row">
                    <div class="col">
                        <h1 id="judul-3" class="h1 text-center judul-history" style="font-family: 'Times New Roman', Times, serif; color:#3B486D">
                            Perjalanan Cinta</h1>
                    </div>
                </div>
        ...
        <section id="gallery" class="mb-3 p-2">
            <div class="container-fluid kartu" style="padding : 10px 10px;">
                <div class="row mb-3">
                    <div class="col">
                        {{-- Judul Gallery --}}
                        <h1 id="judul-2" class="h1 text-center" style="font-family: 'Times New Roman', Times, serif; color:#3B486D">
                            Gallery</h1>
                    </div>
                </div>
                {{-- Pengulangan Foto --}}
            ...
            <div class="container-fluid kartu" style="padding : 10px 10px;">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="javascript:void(0)">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="nama-pengirim" name="nama_pengirim" placeholder="Masukan Nama Anda">
                            </div>
                            {{-- Hadir/Tidak Hadir --}}
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <textarea type="text" class="form-control" id="pesan" name="pesan" placeholder="Masukan Pesan Anda" style="height: 100px"></textarea>
                            </div>
                            <div class="mt-1 mb-3">
                    ...
                    <div class="card border-0 p-2" style="height: 300px; overflow: auto;">
                        <div class="card-body rounded refresh" style="background-image: url('/img/bg-pesan.png'); background-repeat: cover; ">
                            ...
                            <div class="row mb-2">
                                <div class="col d-flex align-items-center">
                                    ...
                                    <p class="ms-3 mb-0 ml-1 text-white">
                                        {{ $row->pengirim }} @if($row->kehadiran == 'Hadir') (<small class="text-info"><b> Hadir </b></small>) @elseif($row->kehadiran ==
                                ...
                                <div class="col d-flex">
                                    ...
                                    <div class="card border-0" style="border-radius:0 7px 7px 7px; background-color:#202C33;">
                                        <div class="card-body p-2">
                                            <small class="mb-0 ml-1 fst-italic text-white">{{ $row->ucapan }}</small>
                                        </div>
                                    </div>
                                </div>
                            </div>
        ...
        <section id="payment" class="mb-3 p-2">
            <div class="container kartu" style="padding : 10px 10px;">
                ...
                <div class="row mb-3 mx-2 p-2 rounded" style="box-shadow: 0px 0px 20px 0px rgba(0, 0, 0, 0.2);">
                    <div class="col-4">
                        <img src="/img/{{ $row->jenis_pembayaran }}.png" style="width: 50px" class="img-fluid rounded-start" alt="...">
                    </div>
                    <div class="col-8">
                        <div class="card-body">
                ...
                <div class="kartu2 p-2" style="background-color: rgb(59, 72, 109)">
                    <div class="row p-4">
                        <div class="col-6 d-flex justify-content-center align-items-center">
                            <img src="/front-end/img/protokol/cucitangan.png" alt="" class="img-thumbnail" width="250px">
                        </div>
                        <div class="col-6 d-flex justify-content-center align-items-center">
